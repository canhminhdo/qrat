...
```
https://github.com/canhminhdo/qrat/releases/tag/v2.0
```
...
// for qualitative reachability analysis
search in TELEPORT with =>! such that P(q2, init[q0]) .

// for quantitative reachability analysis
